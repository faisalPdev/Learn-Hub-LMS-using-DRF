...
class VariantItem(models.Model):
    ...
    current_duration=models.CharField(max_length=1000,null=True,blank=True)
    ...
    def save(self,*args,**kwargs):
        ...
        if self.file:
            ...
            self.current_duration=duration_text
            super().save(update_fields=['current_duration'])
...
class Review(models.Model):
    ...
    date=models.DateTimeField(default=timezone.now)
    review_id=ShortUUIDField(unique=True,length=6,max_length=20,alphabet="123456789")
...
class Notification(models.Model):
    ...
    type=models.CharField(max_length=100,choices=NOTY_TYPE)
