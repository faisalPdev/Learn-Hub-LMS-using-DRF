...
function Review() {
  ...
  const fetchReviews = async () => {
    try {
      await useAxios()
        .get(`teacher/review-list/${UserData()?.teacher_id}/`)
        .then((res) => {
  ...
  const handleReplySubmit = async (e, reviewId) => {
    ...
    try {
      await useAxios()
        .patch(`teacher/review-detail/${UserData()?.teacher_id}/${reviewId}/`, {
          reply: reply,
        })
        .then((res) => {
          console.log(res.data);
                          ...
                          <div className="ms-3 mt-2">
                            <div className="d-flex align-items-center justify-content-between">
                              <div>
                                ...
                                <span>{moment(r.date).fromNow()}</span>
                              </div>
                              <div>
                                <a
                                  href="#"
