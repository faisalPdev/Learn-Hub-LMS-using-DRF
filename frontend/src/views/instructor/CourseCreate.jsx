...
//   useEffect(() => {
//     apiInstance.get(`course/category/`).then((res) => {
//       setCategory(res.data);
//     });
//   }, []);
...
//                         {course.image.preview && (
//                           <img src={course.image.preview} alt="Selected Image" style={{ maxWidth: "100%", maxHeight: "300px" }} />
//                         )}
//                       </div>
...
//                   <div className="card mb-3">
//                     <div className="card-header border-bottom px-4 py-3">
//                       <h4 className="mb-0">Course Variants</h4>
//                     </div>
//                     <div className="card-body">
//                       {variants.map((variant, variantIndex) => (
//                         <div key={variantIndex} className="mb-3">
//                           <label htmlFor={`variantTitle${variantIndex}`} className="form-label">
//                             Variant Title
//                           </label>
//                           <input
...
//                             type="text"
//                             className="form-control"
//                             id={`variantTitle${variantIndex}`}
//                           />
//                           {variant.items.map((item, itemIndex) => (
//                             <div key={itemIndex} className="mt-2">
//                               <label htmlFor={`itemTitle${variantIndex}-${itemIndex}`} className="form-label">
//                                 Item Title
//                               </label>
//                               <input
...
//                                 type="text"
//                                 className="form-control"
//                                 id={`itemTitle${variantIndex}-${itemIndex}`}
//                               />
//                               <label htmlFor={`itemDescription${variantIndex}-${itemIndex}`} className="form-label mt-2">
//                                 Item Description
//                               </label>
//                               <textarea
...
//                                 className="form-control"
//                                 id={`itemDescription${variantIndex}-${itemIndex}`}
//                               />
//                               <label htmlFor={`itemFile${variantIndex}-${itemIndex}`} className="form-label mt-2">
//                                 Item File
//                               </label>
//                               <input
//                                 onChange={(e) => handleItemChange(variantIndex, itemIndex, "file", e.target.files[0], "file")}
//                                 type="file"
//                                 className="form-control"
//                                 id={`itemFile${variantIndex}-${itemIndex}`}
//                               />
