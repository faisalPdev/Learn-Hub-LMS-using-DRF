                ...
                <div className="collapse navbar-collapse p-3" id="sidenav">
                    <div className="navbar-nav flex-column">
                        <ul className="list-unstyled ms-n2 mb-4">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link " to={`/instructor/coupon/`}> <i className='fas fa-tags'></i> Coupon</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link " to={`/instructor/notification/`}> <i className='fas fa-bell'></i> Notifications</Link>
                            </li>
                            <li className="nav-item">
