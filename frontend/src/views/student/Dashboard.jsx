...
function Dashboard() {
    ...
    const fetchData =()=>{
        setFetching(true)
        useAxios().get(`/student/summary/${UserID}`).then((res)=>{
            setStats(res.data[0]);
        });
                ...
                <div className="container">
                    ...
                    <div className="row mt-0 mt-md-4">
                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            ...
                            {fetching === true &&(
                                <div className="mt-4 text-info">Loading...<i className='fa fa-spinner fa-spin'></i></div>
                            )}
                                ...
                                <div className="table-responsive overflow-y-hidden">
                                    <table className="table mb-0 text-nowrap table-hover table-centered text-nowrap">
                                        ...
                                        {courses?.map((c,index)=>(
                                            ...
                                            <td><p className='mt-3'>{c.completed_lesson?.length}</p></td>
                                            ...
                                            {c.completed_lesson?.length === 0 && (
                                                ...
                                                Start course <i className='fas fa-play'></i>
                                                </Link>
                                                </td>
                                            )}
                                            ...
                                            {c.completed_lesson?.length > 0 && (
                                                ...
                                                to={`/student/courses/${c.enrollment_id}/`}
                                                 className='btn btn-primary btn-sm mt-3'>
                                                Continue course <i className='fas fa-play'></i>
                                                </Link>
                                                </td>
                                            )}
