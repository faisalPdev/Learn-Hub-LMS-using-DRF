                ...
                <div className="container">
                    ...
                    <div className="row mt-0 mt-md-4">
                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            ...
                            {fetching === true &&(
                                <div className="mt-4 ">Loading...<i className='fa fa-spinner fa-spin'></i></div>
                            )}
                                    ...
                                    <table className="table mb-0 text-nowrap table-hover table-centered text-nowrap">
                                        ...
                                        {courses?.map((c,index)=>(
                                            ...
                                            {c.completed_lesson?.length === 0 && (
                                                <td>
                                                <button className='btn btn-primary btn-sm mt-3'>Start course <i className='fas fa-arrow-right'></i></button>
                                                </td>
                                            )}
